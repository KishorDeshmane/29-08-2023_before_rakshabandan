...
public class B023_super_admin_service_area_management_edit_page {
	...
	Logger logger = LogManager.getLogger(B023_super_admin_service_area_management_edit_page.class);
	...
	public void verify_that_super_admin_user_is_on_users_service_area_management_edit_page_as_expected_page_title_is(String string) {
		...
		sasam.kebab_menu_edit_is_clicked();
