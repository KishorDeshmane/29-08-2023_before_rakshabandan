...
public class B024_super_admin_service_area_management_change_status_pop_up {
	...
	Logger logger = LogManager.getLogger(B024_super_admin_service_area_management_change_status_pop_up.class);
	...
	public void verify_that_super_admin_user_is_on_users_service_area_management_change_status_pop_up_as_expected_page_title_is(String string) {
		...
		sasam.first_user_kebab_menu_change_status_buttton_is_clicked();
