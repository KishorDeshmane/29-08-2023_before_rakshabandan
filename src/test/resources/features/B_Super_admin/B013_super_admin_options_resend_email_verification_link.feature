...
#
  ...
  #Scenario: Validate that working of an action options resend email verification link button with active super admin user
    ...
    #Then Verify that super_admin search button is able to search the user with "kishor.deshmane@iffort.com" name of user in all users page for resend email verification link
